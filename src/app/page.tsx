      ...
      <section id="contacto" className="border-t border-zinc-200 bg-zinc-100 px-4 py-12">
        <div className="mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            <span className="flex items-center gap-3 text-zinc-500" aria-hidden>
              <a href="#" className="rounded-full p-2 text-zinc-600 transition hover:bg-zinc-200 hover:text-zinc-900" aria-label="Instagram">
              ...
              <a href="#" className="rounded-full p-2 text-zinc-600 transition hover:bg-zinc-200 hover:text-zinc-900" aria-label="LinkedIn">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
